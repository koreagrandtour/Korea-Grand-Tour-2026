...
- 2026 route is not fully finalized.
- Dates: August 14-17, 2026.
- Duration: 4 days.
- Expected distance: approximately 1,500 km.
- Start: Seoul.
- Finish: Yangyang.
- Route identity: inland Korea, valleys, mountain passes, winding roads, rice fields, small villages, farms, cultural/historical stops, scenic roads.

## Confirmed Route Elements
...
- Day 2 could focus on Jeonju, Damyang, and southern inland Korea.
- Day 3 could include Cheongdo, Ulsan, farms, industry, and winding roads.
- Day 4 could include Inje Speedium and final drive to Yangyang.

This is inferred from confirmed anchors and must be labeled as a working draft.

## Operations Dependencies

- Hotel list target: June 30, 2026.
...
- OPEN QUESTION: Exact route order.
